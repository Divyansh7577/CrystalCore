...
public final class CrystalCore extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Material parsedPay =
                Material.matchMaterial(payMatName);

        Material parsedBuy =
                Material.matchMaterial(buyMatName);
        ...
        this.mailboxManager =
                new MailboxManager(this);

        this.mailboxManager.load();

        this.chestLogManager =
                new ChestLogManager(this);
        ...
        this.holeFillerManager =
                new HoleFillerManager();
        ...
        this.webStatsSyncManager =
                new WebStatsSyncManager(this);
        ...
        getCommand("holefiller")
                .setExecutor(
                        new HoleFillerCommand(
                                holeFillerManager
                        )
                );
        ...
        // Sync Player Hub data every 60 seconds.
        getServer()
                .getScheduler()
                .runTaskTimer(
                        this,
                        () -> {
                            ...
                            for (Player player :
                                ...
                                webStatsSyncManager.sync(player);
                            }
        ...
        getLogger().info(
                "CrystalCore has been enabled. "
                        + "Currency: Crystal (Amethyst Shard) | "
                        + "Shop items loaded: "
                        + shopManager
                                .getAllEntries()
                                .size()
    ...
    public WebStatsSyncManager getWebStatsSyncManager() {
        return webStatsSyncManager;
    }
  }
